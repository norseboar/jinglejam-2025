...
- [ ] When player loses, surviving enemies reduce fortress HP
- [ ] HP label updates when fortress takes damage
- [ ] HP cannot go below 0
- [ ] "Restart" button appears when battle ends
- [ ] Clicking "Restart" clears all units
- [ ] Clicking "Restart" re-spawns enemies
- [ ] Clicking "Restart" resets UI to placement phase
- [ ] Can spawn new units after restart
- [ ] Can start a new battle after restart
- [ ] Console shows damage and restart messages
